...
function App() {
  ...
  return (
    <div className="bg-slate-900 min-h-screen flex flex-col items-center text-white p-4 font-sans transition-colors duration-300">
      <header className="w-full max-w-4xl text-center my-8">
        <h1 className="text-4xl md:text-5xl font-bold text-cyan-400">GrowthProAI</h1>
        <p className="text-slate-400 mt-2">Mini Local Business Dashboard</p>
      </header>
      ...
      <main className="w-full max-w-md">
        ...
        <div className="bg-slate-800 p-6 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="name" className="block text-slate-300 mb-2">Business Name</label>
              <input
                type="text"
                id="name"
                name="name"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-cyan-600 hover:bg-cyan-700 disabled:bg-slate-600 text-white font-bold py-2 px-4 rounded-md flex items-center justify-center transition-all"
            >
        ...
        {businessData && (
          <div className="mt-8 bg-slate-800 p-6 rounded-lg shadow-lg animate-fade-in">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center bg-slate-700 p-3 rounded-md">
                <span className="text-slate-300">Number of Reviews</span>
                <span className="font-bold text-lg text-cyan-400">{businessData.reviews}</span>
              </div>
              <div className="bg-slate-700 p-3 rounded-md">
                <span className="text-slate-300 block mb-2">AI-Generated SEO Headline</span>
